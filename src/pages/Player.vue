<template>
  <div>
    <video v-if="isFoundOtherPlayerRTCId" id="their-video" height="100%" autoplay muted playsinline></video>
...
<script>
  ...
  const { mapActions: mapDuelActions, mapState: mapDuelState } = createNamespacedHelpers("duel");
